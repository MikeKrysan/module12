...
/*
1. Нам нужно указать реальный IP, данная машина должна быть открыта для доступа извне
и это реализуется покупкой белого IP, либо организовать VPN-сервер (через удаленное соединение)
 */